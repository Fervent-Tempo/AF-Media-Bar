...
{
    public static LayoutContainerElement CreateInlineContainer(LayoutContainerKind kind)
    {
    ...
    public static LayoutEdgeContainer CreateEdgeContainer(LayoutEdge edge)
    {
    ...
    public static bool TryResetInlineContainer(
    ...
    public static bool TryResetEdgeContainer(
        LayoutProfile profile,
        string instanceId,
        out LayoutProfile updated)
    {
    ...
    public static bool TryAddInlineContainer(
        LayoutProfile profile,
    ...
    public static bool TryAddEdgeContainer(
        LayoutProfile profile,
        LayoutEdge edge,
    ...
    public static bool TrySetEnabled(LayoutProfile profile, string instanceId, bool enabled, out LayoutProfile updated)
    {
        var state = new EditState();
        var inline = profile.InlineContainers.Select(container =>
        {
    ...
    public static bool TryUpdateInlineContainer(
        LayoutProfile profile,
        string instanceId,
        int proximityDip,
    ...
    public static bool TryUpdateEdgeContainer(
        LayoutProfile profile,
        string instanceId,
        LayoutEdge edge,
        LayoutEdge? unavailableEdge,
