...
internal static class StringsEn
{
    ...
    internal static void Register(LanguageTable table)
    {
        ...
        table.Add("DisplayModes.Placement.Row.Monitor.Description", "Selects the monitor whose taskbar carries the media bar");
        ...
        table.Add("DisplayModes.Rest.Notice", "The spectrum and performance components are switched and tuned under \"Media and notifications → Rest-layer components\"; the media text size is under \"Appearance → Media bar text\".");
