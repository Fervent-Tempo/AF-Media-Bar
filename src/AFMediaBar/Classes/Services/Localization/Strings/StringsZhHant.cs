...
table.Add("Lyrics.Row.LineGap.Description", "兩行歌詞之間的間距；空間不夠時自動收緊，不會擠出工作列（預設 0）");
table.Add("Lyrics.Row.LineGap.Title", "雙行行距");
table.Add("Lyrics.Row.CharacterSpacing.Description", "按字號的百分比拉開字距，英文單詞保持完整（預設 0）");
